$(document).ready(function() {
    ...
    var positions = ["sl", "slot-top-mid", "slot-top-right", "slot-mid-left", "slot-mid-mid", "slot-mid-right", "slot-bot-left", "slot-bot-mid", "slot-bot-right"];
    ...
    var characters = {
        'brother_big': {
            imageUrl: "images/brother_big.png"
        },
        'brother_mid': {
            imageUrl: "images/brother_mid.png"
        },
        'brother_small': {
            imageUrl: "images/brother_small.png"
        },
        'dad': {
        ...
        'sister_big': {
            imageUrl: "images/sister_big.png"
        },
        'sister_mid': {
            imageUrl: "images/sister_mid.png"
        },
        'sister_small': {
            imageUrl: "images/sister_small.png"
        },
    };
